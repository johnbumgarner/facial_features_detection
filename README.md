...
The Haar Cascade classifier <i>Frontal Face</i> was the only algorithm that was able to properly identify that core facial characteristic on this photograph. Both the <i>Eyes</i> and <i>Nose</i> classifiers failed to detect those facial characteristics in the image. Like in the previous <i>Black Swan</i> photo the mouth classifier also had difficulties accurately locating the mouth area in the photograph of <i>Natalie Portman</i> wearing sunglasses. The results of the mouth classifier are shown below.
